...
def is_duplicate(
    ...
    Uses word-token Jaccard similarity and options set overlap.
    """
    new_words = set(re.findall(r"\w+", new_question.stem.lower()))

    for existing in existing_questions:
        existing_words = set(re.findall(r"\w+", existing.stem.lower()))
